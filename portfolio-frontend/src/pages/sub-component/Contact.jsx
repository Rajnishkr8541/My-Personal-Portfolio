    ...
    <div className="overflow-x-hidden">
      ...
      <form onSubmit={handleSendMessage} className="flex flex-col gap-6">
        ...
        <div className="flex justify-end">
          {
            !loading ? <Button className="w-full sm:w-52 " type="submit">SEND MESSAGE</Button> : <button disabled type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 inline-flex items-center">
